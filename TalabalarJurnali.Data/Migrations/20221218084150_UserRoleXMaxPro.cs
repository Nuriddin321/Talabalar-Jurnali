        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StatDate = table.Column<DateTime>(type: "TEXT", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppUserGroup", x => new { x.GroupId, x.GroupId1 });
                    table.ForeignKey(
                        name: "FK_AppUserGroup_AspNetUsers_GroupId",
                        column: x => x.GroupId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AppUserGroup_Groups_GroupId1",
                        column: x => x.GroupId1,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_StudyDays_Groups_GroupId",
                        column: x => x.GroupId,
                        principalTable: "Groups",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                name: "StudentStatsOfDays",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "TEXT", nullable: false),
                    LessonParticipatingStatus = table.Column<int>(type: "INTEGER", nullable: false),
                    LatenessTime = table.Column<uint>(type: "INTEGER", nullable: true),
                    StudyDayId = table.Column<Guid>(type: "TEXT", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_StudentStatsOfDays", x => x.Id);
                    table.ForeignKey(
                        name: "FK_StudentStatsOfDays_StudyDays_StudyDayId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserId = table.Column<Guid>(type: "TEXT", nullable: false),
                    MarkDate = table.Column<DateTime>(type: "TEXT", nullable: false),
                    StudentStatsOfDayId = table.Column<Guid>(type: "TEXT", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Marks_StudentStatsOfDays_StudentStatsOfDayId",
                        column: x => x.StudentStatsOfDayId,
                        principalTable: "StudentStatsOfDays",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Marks_StudentStatsOfDayId",
                table: "Marks",
                column: "StudentStatsOfDayId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StudentStatsOfDays_StudyDayId",
                table: "StudentStatsOfDays",
                column: "StudyDayId");

            migrationBuilder.CreateIndex(
                name: "IX_StudyDays_GroupId",
                table: "StudyDays",
                column: "GroupId");
        }
